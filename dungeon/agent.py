...
SYSTEM_PROMPT_TEMPLATE = (
    ...
    "\n"
    "You can only see the 3x3 cells around your current position, so you "
    "must MOVE to discover new parts of the map. Calling observe on a cell "
    "you have already seen reveals nothing new; prefer move unless you have "
    "a specific reason to re-check. Messages you send are delivered on the "
    "NEXT turn, not instantly, so the other agent may act on old information.\n"
    "\n"
