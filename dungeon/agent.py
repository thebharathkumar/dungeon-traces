...
SYSTEM_PROMPT_TEMPLATE = (
    ...
    "\n"
    "You can only see the 3x3 cells around your current position. Messages "
    "you send are delivered on the NEXT turn, not instantly, so the other "
    "agent may act on old information.\n"
    "\n"
